"""
Django settings for dream_land1 project.
...
WSGI_APPLICATION = "dream_core.wsgi.application"
...
if 'test' in sys.argv:
    ...
    DATABASES["default"]["OPTIONS"] = {"options": "-csearch_path=dreams"}
    DATABASES["default"]["TEST"] = {
        "OPTIONS": {"options": "-csearch_path=dreams"}
    }
